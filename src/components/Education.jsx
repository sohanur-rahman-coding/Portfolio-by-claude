                ...
                <div className="card edu-card" style={{ padding: "clamp(1.5rem,3vw,2.25rem)", borderRadius: 20, background: "rgba(255,255,255,0.022)", border: "1px solid rgba(255,255,255,0.055)" }}>
                  ...
                  <div style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap", marginBottom: "1rem" }}>
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.7rem", color: "var(--muted2)", display: "flex", alignItems: "center", gap: "0.4rem", letterSpacing: "0.04em" }}>
                      <motion.svg animate={{ rotate: [0, 5, -5, 0] }} transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }} width="12" height="12" fill="none" stroke="var(--orange)" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></motion.svg>
                      {edu.period}
                    </span>
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.7rem", color: "var(--muted2)", display: "flex", alignItems: "center", gap: "0.4rem", letterSpacing: "0.04em" }}>
                      <motion.svg animate={{ y: [0, -2, 0] }} transition={{ repeat: Infinity, duration: 2, ease: "easeInOut" }} width="12" height="12" fill="none" stroke="var(--orange)" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></motion.svg>
                      {edu.location}
                    </span>
                  </div>
